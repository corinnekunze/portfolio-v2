...
paragraph_1: Pac Global is an insurance brokerage company that had a need for a new workflow to create insurnace claims when items get damaged or lost in transit. What started out as a single feature request, turned into a feature rich new workflow for being able to handle their insurance claims through an automated process. We were able to deliver a robust set of new functionality on a rigorous timeline so that Pac Global's customers could begin using it as soon as possible.
